...
:telescope: Работаю аналитиком данных в научно-исследовательском институте, где занимаюсь сбором, обработкой и анализом данных для исследований. Основные задачи включали:
